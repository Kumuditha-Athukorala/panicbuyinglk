	...
	<div id="category-list" class="row">
		<div class="col-sm-2">
			<div class="list-group" id="list-tab" role="tablist">
				...
				<a class="list-group-item list-group-item-action"
					...
					role="tab" aria-controls="settings">Grocery</a>
			</div>
		</div>
		<div class="col-sm-10">
		<div class="tab-content" id="nav-tabContent">
				...
				%>
					...
					<table>
						...
						<br>
							...
							<tr style="text-align: center;"><%=p.getProductName() %></tr><br>
							<tr style="text-align: center;">LKR <%=p.getUnitPrice() %></tr><br>
						</tbody>
					</table>
			...
			<div class="tab-pane fade" id="list-fassion" role="tabpanel"
				...
				<div class="row">
				<% 
					ArrayList<Product> grocery = (ArrayList<Product>)request.getAttribute("listofGrocery"); 
					int m = 0;
