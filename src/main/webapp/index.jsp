...
<body>
	...
	<div id="category-bar">
		...
		<div id="about-us" class="row">
			<div class="col-sm-1">mjgjyh</div>
			<div class="col-sm-10">kuryg</div>
			<div class="col-sm-1">urtsev</div>
		</div>
</body>
